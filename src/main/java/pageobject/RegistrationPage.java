...
public class RegistrationPage {
    ...
    @Step("Введите регистрационные данные в поля email, имя и пароль")
    ...
    @Step("Получение верного ответа при вводе неправильного пароля")
    public boolean isWrongPasswordDisplayed() {
        return driver.findElement(wrongPassword).isDisplayed();
    }

    @Step("Клик на кнопку входа внизу страницы")
